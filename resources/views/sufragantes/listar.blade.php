    ...
    <table class="table table-bordered border-dark table-sm">
        ...
        @foreach($listado as $listados)
          <tr>
            ...
            <td class="table-info"> <a href="{{route('user.edit', $listados->id)}}" class="btn btn-warning btn-sm"> Editar </a> 
              <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#modal-delete-{{$listados->id}}">
                Eliminar
              </button>
            </td>
          </tr>
